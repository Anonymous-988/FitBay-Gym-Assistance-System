			...
			<div id="right_content">
				<div id="headline">
					...
					<div id="products_box" style="background-image: url(images/bg2.jpg)">
                                                                                                    ...
                                                                                                    <h2  style= "color: yellow;text-align:center;"> Khushi Shah : 7038180351</h2>
                                                                                                     <h2 style= "color: yellow;text-align:center;"> Sumant Pujari : 9881257715</h2>
